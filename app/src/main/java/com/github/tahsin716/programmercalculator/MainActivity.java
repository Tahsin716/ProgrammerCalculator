package com.github.tahsin716.programmercalculator;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void keypadEnabled() {
        ...
        btn2.setTextColor(Color.parseColor("#8b7991"));
        btn3.setTextColor(Color.parseColor("#8b7991"));
        btn4.setTextColor(Color.parseColor("#8b7991"));
        btn5.setTextColor(Color.parseColor("#8b7991"));
        btn6.setTextColor(Color.parseColor("#8b7991"));
        btn7.setTextColor(Color.parseColor("#8b7991"));
        btn8.setTextColor(Color.parseColor("#8b7991"));
        btn9.setTextColor(Color.parseColor("#8b7991"));
